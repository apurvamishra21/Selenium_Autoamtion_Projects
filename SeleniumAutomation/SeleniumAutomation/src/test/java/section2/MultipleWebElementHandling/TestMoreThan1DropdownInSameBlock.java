...
public class TestMoreThan1DropdownInSameBlock {
	...
	public static void main(String[] args) {
		...
		//here we are not doing driver.fE we have to fetch link from that particular block so we are  doing dropdown.fE 
	...
	//when multiple webelements are there with the same property
